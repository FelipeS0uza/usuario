package com.felipesouza.usuario.infrastructure.security;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Override
    //throws é usada na assinatura de um metodo para declarar que ele pode lançar uma ou mais exceções
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        // Busca o usuário no banco de dados pelo e-mail
        Usuario usuario = usuarioRepository.findByEmail(email)
                //Caso não exista lança um erro com a mensangem de não encontrado
